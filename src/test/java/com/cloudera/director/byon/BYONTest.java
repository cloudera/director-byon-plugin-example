...
import static com.cloudera.director.byon.compute.BYONComputeInstanceTemplateConfigurationProperty.NETWORK;
import static com.cloudera.director.byon.compute.BYONComputeProviderConfigurationProperty.HOSTS;
...
public class BYONTest {
  ...
  public void testFullCycle() throws InterruptedException {
    ...
    environmentConfig.put(USERNAME.getConfigKey(), "admin");
    environmentConfig.put(PASSWORD.getConfigKey(), "password");

    CloudProvider provider = launcher.createCloudProvider(
        BYONCloudProvider.ID, new SimpleConfiguration(environmentConfig));
    ...
    computeConfig.put(HOSTS.getConfigKey(), "10.0.1.5, 10.0.1.15");
    ...
    templateConfig.put(IMAGE.getConfigKey(), "image-123");
    templateConfig.put(TYPE.getConfigKey(), "multi-cpu-instance");
    templateConfig.put(NETWORK.getConfigKey(), "dummy");
